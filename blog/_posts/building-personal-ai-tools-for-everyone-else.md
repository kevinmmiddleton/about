...
The best part of building something for yourself is the day someone else wants it too. My friends watched me stop doom-refreshing and asked the obvious thing: can I have that? For a while my answer would trail into a mumble, because the whole system was built for exactly one person (me). This month, that changes. I turned it into a real, invite-only product, [Shortlist](https://shortlist.middleton.io/), and I'm about to hand the first keys to five close friends and colleagues. [I can't wait to see how this turns out!](https://www.youtube.com/watch?v=PEADQ6qfQtY)
...
That gets you the do-it-yourself version. The full one is [Shortlist](https://shortlist.middleton.io/), the invite-only dashboard my friends log into, and the part I run so they don't have to. Two ways in: build your own with the open-source bones above, or [request an invite to Shortlist](https://shortlist.middleton.io/).
...
What started as a tool with exactly one user now has a name, a login, and a waitlist. I think that's kinda cool! The best job search tool I've ever used had exactly one user (me) and it got better the more I used it and understood my own friction points. It'll get better still once my friends start telling me what they need.
