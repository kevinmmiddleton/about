...
**Sometimes they don't see it, even when it's obvious**. I've been a really strong fit for roles and still gotten the no. I've applied to roles that felt like I wrote the job descriptions myself. Early on in your interviewing process, that messes with your head. But the takeaway isn't that you're not good. It's that there are a lot of talented people looking right now, and plenty of them are great fits too. The math is brutal. The verdict on you isn't.
...
**And if you can,** [**do it in public**](https://www.linkedin.com/posts/kevinmiddleton_if-youre-building-things-in-public-put-activity-7457612445721772032-U6Oe). Share what you're building and learning. It keeps you sharp, it keeps you current, and it shows everyone watching that you're active and worth a conversation. The person who's visibly doing the work is a lot easier to pick than a name on a list.

**I built a few Claude plugins during my own search. They're free, and here to help you level up.**

> [**Job Search Agent**](https://github.com/kevinmmiddleton/job-search-agent) · your AI recruiter, so you can run more reps without losing your mind
> 
> [**Personal Site**](https://github.com/kevinmmiddleton/personal-site) · steps you through building a portfolio website, so your accomplishments live somewhere you own
> 
> [**Build with Claude**](https://github.com/kevinmmiddleton/build-with-claude) · helps you upskill by walking you through shipping apps from your phone
